...
Optional `GIDEON_MCP_HOSTED_MAX_RETRIES` and `GIDEON_MCP_HOSTED_RETRY_DELAY_MS` tune transient hosted API retry behavior. Revision conflicts, missing preconditions, auth failures, and validation failures are not retried.
