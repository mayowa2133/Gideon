...
export interface FlowExecutionDto { id: string; captureRunId: string; flowId: string; flowRevision: number; status: "queued" | "dry_running" | "recording" | "normalizing" | "verified" | "failed" | "blocked" | "canceled"; attempt: number; blockerCode: string | null; normalizedClipArtifactId: string | null; updatedAt: string }
