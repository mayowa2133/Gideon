...
| Regression | Repository lint, strict TypeScript, capture suite, full suite, desktop/web builds | 127 capture tests passed; 531 full tests passed with one intentional skip; builds passed |
