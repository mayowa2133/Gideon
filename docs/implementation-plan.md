...
3. Add observability.
   ...
   - Metrics for queue latency, persisted queue depth/age, lease recovery count, terminal failure rate, provider latency/errors, render duration, storage latency/bytes, and usage records.
