...
The next slice should run the provider canary against staging credentials/fixtures or add project/billing relational expansion while keeping desktop and MCP compatibility intact.
