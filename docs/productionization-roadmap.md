...
- Extend the signed hosted HTTP queue handoff, intake HTTP handler, dispatcher, and shared lease/heartbeat primitives into a durable Redis/BullMQ or equivalent backend.
