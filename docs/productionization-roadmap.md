...
3. Add a live staging hosted-MCP smoke that verifies SSO/session policy, deployed metric export, edit revision conflicts, and job enqueueing before removing snapshot reads entirely.
