...
3. Run the live production promotion gate with staging upload-to-export, hosted MCP smoke, deployed metric export, signed/notarized release credentials, self-verified promotion evidence, and archived release evidence before removing snapshot reads entirely.
