...
1. Run `pnpm production:check`, then run the strict staging-readiness gate, `pnpm staging:smoke -- --live`, and provider canary against staging credentials and small ASR/OCR fixtures.
