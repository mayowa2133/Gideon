...
- Extend the signed hosted HTTP queue handoff, intake HTTP handler, dispatcher, and store-backed lease/heartbeat coordinator into a durable Redis/BullMQ or equivalent backend.
