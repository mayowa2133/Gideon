...
if (dryRun) {
  ...
  console.log("6. Require artifact name, git commit, timestamps, skip-package flag, step count, provider capabilities, and release receipt status to stay consistent.");
  process.exit(0);
}
