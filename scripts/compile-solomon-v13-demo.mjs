...
const output = path.join(root, "tmp", "solomon-creator-story-v13-performance", "fixture");
const fixture = compileSolomonV13DemoContent(Number(process.env.SOLOMON_V13_FIXTURE_SEED ?? 101010));

await fs.mkdir(output, { recursive: true, mode: 0o700 });
await fs.writeFile(path.join(output, "solomon-v13-demo-content.json"), `${JSON.stringify(fixture, null, 2)}\n`, { mode: 0o600 });
