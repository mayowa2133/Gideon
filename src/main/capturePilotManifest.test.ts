...
function validManifest() {
  return {
    ...
    presentation: { viewport: { width: 1440, height: 900 }, initialHoldMs: 1500, beforeActionMs: 450, afterActionMs: 900, finalHoldMs: 2000, showPointer: true, pointerMoveMs: 350, typingDelayMs: 45 },
    workflows: [{
