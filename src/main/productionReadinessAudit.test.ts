...
describe("production readiness audit", () => {
  ...
  it("tracks the current README completion estimate", () => {
    ...
    expect(readme).toContain("Current engineering estimate: **99.99999999988% complete**");
    expect(audit).toContain("Current engineering estimate: **99.99999999988% complete**");
  });
