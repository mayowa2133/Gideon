...
describe("production readiness audit", () => {
  ...
  it("tracks the current README completion estimate", () => {
    ...
    expect(readme).toContain("Current engineering estimate: **99.99999999986% complete**");
    expect(audit).toContain("Current engineering estimate: **99.99999999986% complete**");
  });
