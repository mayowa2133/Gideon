...
export const Root:React.FC = () => <Composition id="SolomonCreatorStoryV22Performance" component={Story} durationInFrames={1155} fps={30} width={1080} height={1920} defaultProps={{} as Record<string,unknown>}/>;
