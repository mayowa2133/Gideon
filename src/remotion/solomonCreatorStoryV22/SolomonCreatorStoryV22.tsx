...
const Friction:React.FC<{scene:V22Scene}> = ({scene}) => {const frame=useCurrentFrame();return <AbsoluteFill ><KineticHeadline sceneId="friction" accentColor={CORAL} top={228} maxHeightPx={258} duration={30}/>{/* The surfaces flank the presenter rather than sitting behind or above it.
