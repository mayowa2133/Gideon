...
const opportunityStoryBase = z.object({
  version: z.enum(["meet-solomon-opportunity-scroll-v1", "meet-solomon-opportunity-scroll-v2", "meet-solomon-opportunity-scroll-v3"]), id: z.string().regex(/^[a-z][a-z0-9-]{0,63}$/), title: z.string().min(3),
